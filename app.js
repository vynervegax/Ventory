...
app.use('/invoice/edit', express.static(publicDirectoryPath))
app.use('/invoice/delete', express.static(publicDirectoryPath))
...
app.use('/item/new', express.static(publicDirectoryPath))
...
app.use('/party/new', express.static(publicDirectoryPath))
